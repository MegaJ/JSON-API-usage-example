...
You can follow what I did throughougt the rest of the project by inspecting my commit history. This project took me well over 2 hours because I had to research what I was doing, but I had a lot of fun! I learned a lot regardless.
...
2. ```createDivFromJson()```
     ...
     This simply creates ```<div>``` elements once I have new JSON. There is likely a prettier way than the verbosity inside the ```for``` loop. This deserves a refactor. I decided not to use jQuery calls here because vanilla js is much faster.
